...
class _AbstractionQuestionTwoScreenState
  ...
  void initState() {
    ...
    _playInstruction(); // 🆕 تشغيل التعليمات عند البدء
  }
    ...
    return Stack(
      children: [
        TestQuestionScaffold(
          ...
          // 🆕 زر الإعادة يختفي أثناء التسجيل وأثناء تشغيل الأوتوبلاي
                      ...
                      child: GestureDetector(
                        ...
                        child: ElevatedButton.icon(
                          ...
                          style: ElevatedButton.styleFrom(
                            ...
                            backgroundColor: (_isRecording || _hwRecording)
                                ? Colors.red
                                : null,
                            foregroundColor: (_isRecording || _hwRecording)
                                ? Colors.white
                                : null,
