...
class _AbstractionQuestionTwoScreenState
  ...
  void initState() {
    ...
    _instructionPlayer.play(AssetSource('audio/abstraction2.mp3'));
  }
  ...
  Future<void> _recordFromMobile() async {
    if (_isRecording) {
      ...
      debugPrint('✅ ABSTRACTION Q2 MOBILE STOP: $path');
    } else {
      ...
      debugPrint('🎙️ ABSTRACTION Q2 MOBILE START');
    }
  }
  ...
  Future<void> _toggleHardwareRecording() async {
    if (_hwRecording) {
      ...
      debugPrint('✅ ABSTRACTION Q2 HW STOP: ${file.path}');
    } else {
      await http.post(
      ...
      debugPrint('🎙️ ABSTRACTION Q2 HW START');
    }
  }
  ...
  Future<void> _submit() async {
    ...
    final result =
        await _apiService.checkAbstraction(_recordedPath!, 2);
    ...
    debugPrint('SCORE Q2: $score');
    debugPrint(
      'TOTAL ABSTRACTION SCORE: ${TestSession.abstractionScore}',
    );
    debugPrint('==============================');
