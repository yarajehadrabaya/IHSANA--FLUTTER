...
class _LanguageIntroScreenState extends State<LanguageIntroScreen>
  ...
  Future<void> _playVoice() async {
    ...
    await _player.play(
      AssetSource('audio/language_intro.mp3'),
    );
                  ...
                  child: Column(
                    children: [
                      _instructionItem(
                        ...
                        'سيتم قراءة كل سؤال لك صوتيًا، وهناك أسئلة ستقرأ لمرة واحدة فقط.',
                      ),
                      _instructionItem(
                        Icons.mic_none,
                        'بعد سماع السؤال، قم بتسجيل إجابتك بصوت واضح.',
                      ),
                      _instructionItem(
                        Icons.refresh,
                        'يمكنك إعادة تسجيل الإجابة إذا لزم الأمر.',
                      ),
                      _instructionItem(
                        Icons.check_circle_outline,
                        'بعد الانتهاء، اضغط على زر الإنهاء والتحليل للمتابعة.',
                      ),
                    ],
                  ),
                ),
                    ...
                    onPressed: _canStart
                        ? () {
                            Navigator.pushReplacement(
                              ...
                              MaterialPageRoute(
                                builder: (_) =>
                                    const SentenceRepetitionOneScreen(),
                              ),
                            );
                          }
                        : null,
