...
// ملاحظة: استبدلي هذا المسار بمسار شاشة الأسئلة الفعلية عندك
import 'package:ihsana/test/orientation/orientation_screen.dart'; 

class OrientationIntroScreen extends StatefulWidget {
  const OrientationIntroScreen({super.key});

  @override
  State<OrientationIntroScreen> createState() => _OrientationIntroScreenState();
}

class _OrientationIntroScreenState extends State<OrientationIntroScreen>
  ...
  Future<void> _playVoice() async {
    ...
    await _player.play(
      AssetSource('audio/orientation_intro.mp3'),
    );
